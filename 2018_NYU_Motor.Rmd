...
boro_plot = tidy_data %>% 
  ...
  mutate(text_label1 = str_c("accident: ", accident), 
         ...
         text_label3 = str_c("killed: ", killed)) %>% 
  ...
  add_trace(x = ~borough, y = ~prop_killed, type = 'bar', name = 'injury', text = ~text_label3, alpha = 0.8) %>%
...
hour_plot = hour_table %>%
  ...
  add_trace(x = ~hour, y = ~prop_killed, type = 'scatter', mode = 'lines', name = 'killed', text = ~text_label3, alpha = 0.8) %>%
...
hour_plot %>%
  layout(shapes = list(type = "rect", fillcolor = "pink", line = list(color = "pink"), opacity = 0.3, x0 = 8, x1 = 20, xref = "x", y0 = 0, y1 = 0.08, yref = "y"))
