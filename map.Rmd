...
output: 
  html_document: 
    ...
    toc_float: true
---
### Things you need to do if you went into a vehicle collison.
...
Number of accident differs according to places.To be specific, more people injured on highway. Brooklin and Bronx had more injured cases than other boroughs. The map constructed by injured cases refected the severity of car collsions among boroughs.**Hover on the map to explore the cases**
