...
We find it interesting to look at York city motor vehicle collision data. Traffic is very heavy in New York, and many people relay on motor vehicles for transportation. Car crashes happens every single day. We want to look at patterns and association between car crashes and different variables, such as vehicle type or accident location. Maybe a certain type of vehicle tends to have more accident rate? In addition, we want to analyze number/types of people injured and how it relates to location and time of day.  
